			...
			<div class="vertical-align-middle auth-main">
				<div class="auth-box">
					...
					<div class="card">
                        ...
                        <div class="body">
                            <form class="form-auth-small" method="post" action="../App/controller/ajoutpersonnel.php">
                                ...
                                <div class="form-group">
                                    <label for="signup-CIN" class="control-label sr-only">CIN</label>
                                    <input type="text" class="form-control" id="signup-CIN" placeholder="CIN" name="CIN" required>
                                </div>
                                <div class="form-group">
                                    <label for="signup-email" class="control-label sr-only">email</label>
                                    <input type="text" class="form-control" id="signup-email" placeholder="email" name="email" required>
                                </div>
                                  <div class="form-group">
